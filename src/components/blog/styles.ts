...
export const CARD_INTERACTIVE =
  "rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm transition-all duration-300 hover:border-amber-500/40 hover:shadow-[0_0_35px_-12px_rgba(245,158,11,0.45)]";
...
export const GLOW_SHADOW = "shadow-[0_0_60px_-15px_rgba(245,158,11,0.4)]";
