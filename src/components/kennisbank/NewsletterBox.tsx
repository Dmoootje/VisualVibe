  ...
  return (
    <div className="relative overflow-hidden rounded-[18px] border border-[#ff7500]/28 bg-gradient-to-b from-[#ff7500]/[0.14] to-[#ff7500]/[0.03] p-6">
      <div
        ...
        aria-hidden="true"
      />
      <span className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-[13px] bg-gradient-to-br from-red-500 to-[#ff7500] text-white shadow-[0_14px_30px_-12px_rgba(255,90,0,0.9)]">
      ...
      <p className="mb-[18px] text-[13.5px] leading-relaxed text-white/66">
        Elke maand de beste gidsen en tips voor KMO&apos;s in je inbox.
      </p>

      {done ? (
        <div className="flex items-center gap-2.5 rounded-[11px] border border-[#ff7500]/40 bg-[#ff7500]/10 px-4 py-3.5 text-sm font-semibold text-[#ff9a45]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2.5">
          <input
            ...
            className="w-full rounded-[11px] border border-white/14 bg-black/25 px-4 py-3 text-sm text-white outline-none transition-colors focus:border-[#ff7500]/55"
          />
          <input
            type="text"
            tabIndex={-1}
          ...
          <button
            ...
            className="w-full rounded-[11px] bg-gradient-to-r from-red-500 to-[#ff7500] px-4 py-3.5 text-sm font-bold text-white transition-transform hover:-translate-y-0.5 disabled:opacity-70"
          >
