...
export function QuestionCard({ article, index = 0, locale = "nl" }: { article: ArticleCardData; index?: number; locale?: string }) {
    ...
    >
      ...
      <div className="flex min-w-0 flex-col">
        ...
        <div
          ...
          aria-label={`${labels.author}: ${article.author}`}
        >
          {article.authorImage ? (
            <Image
              src={article.authorImage}
              alt={`${labels.profilePhoto} ${article.author}`}
              width={28}
              height={28}
