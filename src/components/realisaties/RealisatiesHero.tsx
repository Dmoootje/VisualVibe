 ...
 */
export function RealisatiesHero({ stack, locale = "nl" }: { stack: HubProject[]; locale?: SupportedLocale }) {
  const en = locale === "en";
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
          ...
          <div>
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.16em] text-[#ff9a45]">
              {en ? "Our work" : "Ons werk"}
            </p>
            <h1 className="mb-4 text-3xl font-bold leading-[1.05] tracking-tight sm:text-4xl md:text-5xl">
              {en ? "VisualVibe case studies" : "Realisaties van VisualVibe"}
            </h1>
            <p className="mb-8 max-w-[560px] text-lg leading-relaxed text-white/70">
              {en ? "Explore websites, photography, video, drone imagery, virtual experiences and podcasts created for businesses in Limburg, Belgium, across Flanders and further afield. Browse by discipline, sector or location." : "Ontdek websites, fotografie, video, dronebeelden, virtuele ervaringen en podcasts die we realiseerden voor bedrijven in Limburg, Vlaanderen en daarbuiten. Bekijk projecten per discipline, sector of locatie."}
            </p>
            <div className="flex flex-col items-stretch gap-3 sm:flex-row sm:items-center">
              ...
              >
                {en ? "View featured projects" : "Bekijk uitgelichte projecten"}
              ...
              >
                {en ? "Explore by discipline" : "Ontdek per discipline"}
              </a>
            </div>
          </div>
