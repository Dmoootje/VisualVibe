/**
 * Inline SVG icons for the share widget. The repo bans image files, so brand
 * marks are hand-drawn single-path glyphs (viewBox 0 0 24 24). Brand marks use
 * fill; utility icons (mail, copy, link, share, check) use stroke.
 */

export type IconProps = { className?: string; size?: number };

export function ShareGlyph({ className, size = 20 }: IconProps) {
  return (
...
export function WhatsAppIcon({ className, size = 19 }: IconProps) {
  return (
...
export function XIcon({ className, size = 17 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function MailIcon({ className, size = 19 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <rect x="2" y="4.5" width="20" height="15" rx="2" />
      <path d="m2.5 6 8.13 5.6a2.4 2.4 0 0 0 2.74 0L21.5 6" />
    </svg>
  );
}
...
export function CheckIcon({ className, size = 18 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
