...
import { sectorIntroConfig, sectorIntroConfigEn } from "./config/sectorIntro.config";
import { HomeSectorMarquee } from "./components/HomeSectorMarquee";
import "./sector-intro.css";

export default function SectorIntro({ locale = "nl" }: { locale?: string }) {
  const copy = locale === "en" ? sectorIntroConfigEn : sectorIntroConfig;
  return (
    <section className="home-deferred-section py-12 sm:py-16 md:py-24">
      ...
      <HomeSectorMarquee locale={locale} />
    </section>
  );
}
