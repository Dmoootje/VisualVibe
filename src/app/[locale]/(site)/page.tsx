...
const HOME_EN = {
  title: "Creative media agency Limburg | VisualVibe",
...
function EnglishHomepageBody() {
  ...
  return <>
    ...
    <section className="container mx-auto px-2.5 py-16 sm:px-4"><h2 className="text-3xl font-bold sm:text-4xl">Based in Limburg, working across the region</h2><p className="mt-4 max-w-3xl text-lg text-white/65">VisualVibe is based in Tongeren-Borgloon and works with businesses throughout Limburg, Flanders, Antwerp province and Dutch Limburg. We also travel further for larger projects.</p><Link href="/regio" className="mt-6 inline-block font-semibold text-amber-400">View all regions</Link></section>
