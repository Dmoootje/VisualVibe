...
function EnglishWebsiteAnalysisPage({ integration, useWidget }: { integration: Awaited<ReturnType<typeof getAnalysisIntegrationPublic>>; useWidget: boolean }) {
  return <div className="relative min-h-screen overflow-hidden text-white">
    ...
    <WebPageJsonLd url={`${businessConfig.url}/en/website-analysis/`} name="Free website analysis" description="Free VisualVibe website analysis for SEO, performance, technical quality, content and AI search visibility." inLanguage="en-BE" primaryImage={TOOL_PAGE_IMAGES.websiteAnalyse.url} />
