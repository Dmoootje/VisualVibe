...
function EnglishAboutPage() {
  ...
  return <div className="vvov-anim relative overflow-hidden text-white">
    ...
    <section className={`${SECTION} pb-16 pt-32`}>
      ...
      <p className="mt-5 max-w-3xl text-lg leading-relaxed text-white/70">Wedding photography has its own dedicated label: WeddingVibe. <NextLink href="/en/wedding-photographer-limburg/" className="font-semibold text-amber-400">Discover WeddingVibe</NextLink>.</p>
      <div className="mt-8 flex flex-wrap gap-4"><QuoteButton mode="kennis" className="vvov-btn">Start a conversation</QuoteButton><NextLink href="/en/case-studies/" className="vvov-btn rounded-xl border border-white/15 px-6 py-3">View our case studies</NextLink></div>
    </section>
